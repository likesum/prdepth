...
from prdepth.optimization.interactive_optimizer import DiverseOptimizer as Optimizer
...
for filename in flist:
    ...
    for m in range(opts.n_estimation):
        ...
        optimizer.update_diversity_cost(sess)
    ...
    if save_dir is not None:
        ...
        ut.save_color_depth(
            nm + '_diverse_best.png', pred, min_depth, max_depth)
